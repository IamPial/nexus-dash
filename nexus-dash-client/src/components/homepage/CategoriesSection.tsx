      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
          ...
          <Link href="/explore" className="mt-4 md:mt-0">
             <Button size="md"  className="bg-[#4f46e5] text-white font-semibold mt-4 md:mt-0">View All Categories &rarr;</Button>
          </Link>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {categoryItems.map((cat, i) => (
            <div key={i} className="bg-slate-50 p-6 rounded-2xl border border-slate-100 hover:bg-white hover:shadow-md transition-all cursor-pointer flex items-center justify-between group">
